//evenimente mouse, coordonate pagina

function onMouseOver() {
	document.getElementsByClassName("imagine")[0].src = "./images/Paste/iepure.jpg";
}

function onMouseOut() {
	document.getElementsByClassName("imagine")[0].src = "./images/Paste/oua.jpg";
}
...
window.onmousedown = function(e) {
	...
	div.style.background = 'url("./images/Paste/fluture.jpg")';
	div.id = "dr";
}
