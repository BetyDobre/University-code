...
//  ChatApp
//
//  Created by user191721 on 4/7/21.
//
...
class ConversationTableViewCell: UITableViewCell {
    ...
    public func configure(with model: Conversation){
        if model.latestMesage.text.starts(with: "https") {
            userMessageLabel.text = ">Media file"
        }
        else{
            userMessageLabel.text = model.latestMesage.text
        }
