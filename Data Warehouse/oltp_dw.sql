...
CREATE TABLE MEDICAMENT(
    id_medicament NUMBER(4) GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE SPECIALIZARE(
    id_specializare NUMBER(4), -- GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE DIAGNOSTIC(
    id_diagnostic NUMBER(4) GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
CREATE TABLE PROCEDURA(
    id_procedura NUMBER(5) GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1),
...
grant select, insert, update, delete on consult_medicament to admin_oltp;
alter session set container = cdb$root;

insert into judet values(1,'dsada');
