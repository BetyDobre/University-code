...
import model.*;
import repositories.OperaRepository;
...
public class RezOperaService {
    private OperaRepository operaRepository;

    public RezOperaService() {operaRepository = new OperaRepository();}

    public void rezervare(Client client, LoginService loginService, Opera opera, LocTeatruOpera loc){
