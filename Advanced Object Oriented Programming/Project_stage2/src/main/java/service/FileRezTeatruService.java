...
import model.*;
import repositories.FileTeatruRepository;
...
public class FileRezTeatruService {
    ...
    private FileTeatruRepository teatruRepository;

    public FileRezTeatruService() {teatruRepository = new FileTeatruRepository();}
