        ...
        if(ans == 1){
            while(command != 0) {
                switch (command) {
                    ...
                    case 9:{
                        ...
                        switch (command2) {
                            case 1: {
                                ...
                                String numeTeatru = scanner.next();
                                System.out.print("Give the actors of the play: ");
                                String actori = scanner.next();
                            ...
                            case 3: {
                                ...
                                String comedianti = scanner.next();
                    ...
                    case 16:{
                        DBLoginService service = new DBLoginService();
                        System.out.print("Give the username: ");
                        String username = scanner.next();
                        System.out.print("Give the password: ");
                        String password = scanner.next();
                    ...
                    case 17:{
                        ...
                        System.out.print("Locuri disponibile in SectorA, SectorB, Balcon si Loja");
                        ...
                        rezerv.rezervare(c, service, t, locuriPiesa.get(loc));
                        break;
                    }
                    case 18:{
                        ArrayList<LocTeatruOpera> locuriPiesa = new ArrayList<>();
                        ...
                        Client c = repositoryDBC.findClientByUsername(username);
                        Opera t = (Opera)repositoryDBT.findSpectacol(ora,date,name);
                    ...
                    case 19:{
                        ...
                        Client c = repositoryDBC.findClientByUsername(username);
                        StandUp t = (StandUp) repositoryDBT.findSpectacol(ora,date,name);

                        rezerv.rezervare(c, service, t, locuri.get(loc));
                        break;
                    }
                    default: {
                        System.out.println("The-command-doesn't-exist");
            ...
            while(command != 0) {
                switch (command) {
                    ...
                    case 16:{
                        FileLoginService service = new FileLoginService();
                        System.out.print("Give the username: ");
                        String username = scanner.next();
                        System.out.print("Give the password: ");
                        String password = scanner.next();
                    ...
                    case 17:{
                        ...
                        FileRezTeatruService rezerv = new FileRezTeatruService();
                        FileLoginService service = new FileLoginService();
                        System.out.print("Client by username: ");
                        String username = scanner.next();
                        System.out.print("Choose by name,hour and date: ");
                    ...
                    case 18:{
                        ...
                        FileRezOperaService rezerv = new FileRezOperaService();
                        FileLoginService service = new FileLoginService();
                    ...
                    case 19:{
                        ...
                        FileRezStandUpService rezerv = new FileRezStandUpService();
                        FileLoginService service = new FileLoginService();
