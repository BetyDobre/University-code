...
public class FileTeatruRepository implements SpectacolRepository<Teatru>{
    ...
    public ArrayList<Teatru> findSpectacolByName(String nume) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare spectacol de teatru dupa nume"));
            Thread t = new Thread(c);
            t.start();
    ...
    public ArrayList<Teatru> findSpectacolByData(String data) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare spectacol de teatru dupa data"));
            Thread t = new Thread(c);
            t.start();
            return result;
    ...
    public ArrayList<Teatru> findSpectacolByNumeTeatru(String numeTeatru) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare spectacol de teatru dupa nume teatru"));
            Thread t = new Thread(c);
            t.start();
            return result;
    ...
    public ArrayList<Teatru> findSpectacolByOra(int ora) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare spectacol de teatru dupa ora"));
            Thread t = new Thread(c);
            t.start();
