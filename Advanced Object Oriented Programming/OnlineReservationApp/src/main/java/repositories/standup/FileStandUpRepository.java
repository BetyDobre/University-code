...
public class FileStandUpRepository implements SpectacolRepository<StandUp> {
    ...
    public ArrayList<StandUp> findSpectacolByName(String nume) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare spectacol de stand-up dupa nume("+nume +")"));
            Thread t = new Thread(c);
            t.start();
    ...
    public ArrayList<StandUp> findSpectacolByData(String data) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare spectacol de stand-up dupa data("+data+")"));
            Thread t = new Thread(c);
            t.start();
            return result;
    ...
    public ArrayList<StandUp> findSpectacolByOra(int ora) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare spectacol de stand-up dupa ora("+ora+")"));
            Thread t = new Thread(c);
            t.start();
