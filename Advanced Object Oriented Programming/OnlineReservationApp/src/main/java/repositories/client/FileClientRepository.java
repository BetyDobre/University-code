...
public class FileClientRepository implements ClientRepository {
    ...
    public Client findClientByUsername(String username) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare client dupa nume(" + username +")"));
            Thread t = new Thread(c);
            t.start();
    ...
    public Client findClientById(int id) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare client dupa ID("+ id +")"));
            Thread t = new Thread(c);
            t.start();
...
//            list.remove(0);
    ...
    public void deleteClientByUsername(String nume) {
        try {
            ...
            AuditService c = (new AuditService("Stergere client " + nume));
            Thread t = new Thread(c);
            t.start();
