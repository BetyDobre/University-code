...
public class FileOperaRepository implements SpectacolRepository<Opera> {
    ...
    public ArrayList<Opera> findSpectacolByName(String nume) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare opera dupa nume(" + nume + ")"));
            Thread t = new Thread(c);
            t.start();
    ...
    public ArrayList<Opera> findSpectacolByData(String data) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare opera dupa data(" + data +")" ));
            Thread t = new Thread(c);
            t.start();
    ...
    public ArrayList<Opera> findSpectacolByNumeOpera(String numeOpera) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare opera dupa nume opera(" + numeOpera +")"));
            Thread t = new Thread(c);
            t.start();
    ...
    public ArrayList<Opera> findSpectacolByOra(int ora) {
        ...
        try {
            ...
            AuditService c = (new AuditService("Cautare opera dupa ora(" + ora + ")"));
            Thread t = new Thread(c);
            t.start();
    ...
    public void deleteSpectacolByNume(String nume){
        try {
            ...
            AuditService c = (new AuditService("Stergere spectacol de opera"));
            Thread t = new Thread(c);
            t.start();
    ...
    public void updateOraSpectacol(int ora_veche, int ora){
        try {
            ...
            AuditService c = (new AuditService("Schimbare ora spectacol de opera"));
            Thread t = new Thread(c);
            t.start();
