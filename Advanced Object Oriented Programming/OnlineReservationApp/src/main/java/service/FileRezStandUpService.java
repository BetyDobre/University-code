...
public class FileRezStandUpService {
    ...
    SpectacolRepository standupRepository= SpectacolRepository.build(SpectacolRepository.Type.FileStandUp);

    public FileRezStandUpService() {}
    ...
    public static FileRezStandUpService getInstance() {
        return FileRezStandUpService.SingletonHolder.INSTANCE;
    }

    private static final class SingletonHolder {
        private static final  FileRezStandUpService INSTANCE = new FileRezStandUpService();
    }
}
